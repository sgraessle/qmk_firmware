...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_all(
      ...
      ESC_MO1,  KC_A,    KC_S,    KC_D,    KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,    KC_SCLN, KC_QUOT,  KC_NO,             KC_ENT,    \
      KC_LSFT,  KC_NO,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  KC_NO,   KC_RSFT,  KC_DEL,    \
      KC_LCTL,  KC_LALT, KC_LGUI,                          KC_SPC,                          KC_RGUI, KC_RALT,  KC_NO,   KC_RCTL,  MO(1)),
  ...
  LAYOUT_all(
      ...
      KC_LSFT,  KC_NO,   KC_NO,   RGB_MOD, BL_STEP,KC_NO,  KC_NO,  KC_VOLD,KC_VOLU,KC_MUTE, KC_END,  KC_PGDN,  KC_RSFT, KC_PGUP,   KC_INS,    \
      KC_TRNS,  KC_TRNS, KC_TRNS,                          KC_TRNS,                         KC_TRNS, MO(0),    KC_HOME, KC_PGDOWN, KC_END),
