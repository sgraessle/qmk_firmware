...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_all(
      ...
      KC_LCTL, KC_LALT, KC_LGUI,                          KC_SPC,                          KC_RGUI, KC_RALT,  KC_NO,   KC_RCTL,  F(0)),
  ...
  LAYOUT_all(
      ...
      KC_LSFT, KC_NO,   KC_NO,   BL_TOGG, BL_STEP,KC_NO,  KC_NO,  KC_VOLD,KC_VOLU,KC_MUTE, KC_END,  KC_PGDN,  KC_RSFT, KC_PGUP,  KC_INS,      \
